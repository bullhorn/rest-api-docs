...
| jobLocation | To-one association | Location sourced from the JobOrder associated to Placement. | | |
...
| location | To-one association | Location sourced from the ClientCorporation associated to Placement. | | |
