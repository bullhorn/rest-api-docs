...
| bteSyncStatus | String (100) | BTE Sync Status allows for viewing whether a Bullhorn placement was synced to BTE successfully, pending, or if there was an issue. | | |
| bteLastSyncDate | Timestamp | BTE Last Sync Date is used to store the date and time of the last known sync a Bullhorn placement was synced into Bullhorn Time & Expense. | | |
