...
Represents a version entity for the JobOrderPayRuleset effective-dated entity.
...
<table>
    ...
    <thead>
        <tr class="header">
            <th>JobOrderPayRulesetVersion fields</th>
            <th>Type</th>
            <th>Description</th>
            <th>Not null</th>
            <th>Read-only</th>
    ...
    <tbody>
        ...
        <tr class="odd">
            <td>isFirst</td>
            <td>Boolean</td>
            <td>True if this is the first job order pay ruleset version.</td>
            <td>X</td>
            <td></td>
        </tr>
        <tr class="even">
