...
totalOnly | no | (true/false) When set to true, only the total count of records matching the where parameter will be returned. In this scenario, only the where parameter is required and all others will be ignored.
